...
def optimize(verbose=False,
    ...
    def optimize_decorator(pype_func):
        '''
        ...
        def optimize_wrapper(*args):
            ...
            print_tree(tree,'parse tree before:',verbose)
            ...
            print_tree(tree,'parse tree after return replacer:',verbose)
            ...
            print_tree(tree,'after call name replacer tree is',verbose)
            '''
            ...
            '''
            pypeValReplacer=PypeValReplacer()
            tree,recompiled_pype_func=apply_tree_transformation(tree,
                                                                pypeValReplacer,
                                                                originalFuncName,
                                                                glbls,
            ...
            print_tree(tree,'after operator replacer tree is',verbose)
            ...
            print_tree(originalTree,'printing final tree',verbose)
            '''
